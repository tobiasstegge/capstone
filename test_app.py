...
class TestCase(unittest.TestCase):
    ...
    def test_post_customers(self):
        res = self.client.post(
            '/customers', json=self.new_customer, headers=self.header_admin)
        data = json.loads(res.data)
    ...
    def test_post_order(self):
        self.client.post('/customers', json=self.new_customer,
                         headers=self.header_admin)
        res = self.client.post(
            '/orders', json=self.new_order, headers=self.header_admin)
        data = json.loads(res.data)
    ...
    def test_patch_customers(self):
        ...
        res = self.client.patch(
            '/customers/1', json=self.new_customer, headers=self.header_admin)
        data = json.loads(res.data)
    ...
    def test_post_customers_user(self):
        res = self.client.post(
            '/customers', json=self.new_customer, headers=self.header_user)
        data = json.loads(res.data)
    ...
    def test_post_order_user(self):
        ...
        res = self.client.post(
            '/orders', json=self.new_order, headers=self.header_user)
        data = json.loads(res.data)
    ...
    def test_patch_customers_user(self):
        self.client.post('/customers', json=self.new_customer,
                         headers=self.header_user)
        res = self.client.patch(
            '/customers/1', json=self.new_customer, headers=self.header_user)
        data = json.loads(res.data)
